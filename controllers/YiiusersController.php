...
use app\models\YiiusersSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * YiiusersController implements the CRUD actions for Yiiusers model.
 */
class YiiusersController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new YiiusersSearch();
